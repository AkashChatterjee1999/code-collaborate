...
class ParticipantComponent extends React.Component {
  ...
  render() {
    return (
      <Container className="p-3 d-flex" style={{ backgroundColor: colorConfigs.darkGrey }}>
        <Container className="d-flex m-0 p-0" style={{ float: "left" }}>
          <div
            ...
            <img src={this.props.clientPic} alt="person" className="m-auto w-100 h-100" />
          </div>
          <div
            style={{
              width: "10px",
          ...
          <div className="mx-2 px-1">
            ...
            <p className="m-0" style={{ color: "gray", fontSize: "10.5px", fontWeight: 400 }}>
              {this.props.location}
            </p>
          </div>
        </Container>
        <Container className="p-0" style={{ float: "right", width: "max-content" }}>
          <Row className="m-auto" style={{ width: "100px", justifyContent: "space-evenly" }}>
            <div className="px-0" style={{ width: "max-content" }}>
              {this.props.streamConstraints && this.props.streamConstraints.audio ? (
            ...
            <div className="px-0" style={{ width: "max-content" }}>
              {this.props.streamConstraints && this.props.streamConstraints.video ? (
